 ...
 *  current MAGNIFICATION and system DPI instead of querying the monitor EDID data.
 *
 *  @thread_safety This function must only be called from the main thread.
 *
 *  @sa @ref monitor_properties
 ...
 *  bit depth (the sum of all channel depths) and then by MAGNIFICATION area (the
 ...
 *
 *  For full screen windows, the specified size becomes the MAGNIFICATION of the
 ...
 *  at full MAGNIFICATION on Retina displays unless the `NSHighMAGNIFICATIONCapable`
 *  key is enabled in the application bundle's `Info.plist`.  For more
 *  information, see
 *  [High MAGNIFICATION Guidelines for OS X](https://developer.apple.com/library/mac/documentation/GraphicsAnimation/Conceptual/HighMAGNIFICATIONOSX/Explained/Explained.html)
 ...
 *
 *  For full screen windows, this function updates the MAGNIFICATION of its desired
 *  video mode and switches to the video mode closest to it, without affecting
 *  the window's context.  As the context is unaffected, the bit depths of the
 *  framebuffer remain unchanged.
 *
 *  If you wish to update the refresh rate of the desired video mode in addition
 *  to its MAGNIFICATION, see @ref glfwSetWindowMonitor.
 *
 ...
 *  MAGNIFICATION is restored until the window is restored.
 *
 ...
 *  does nothing.
 *
 *  If the specified window is a full screen window, the MAGNIFICATION chosen for
 ...
 *  is specified.
 *
 *  If you only wish to update the MAGNIFICATION of a full screen window or the
 ...
 *  was initialized.
 *
 *  The MAGNIFICATION of the timer is system dependent, but is usually on the order
 *  of a few micro- or nanoseconds.  It uses the highest-MAGNIFICATION monotonic
